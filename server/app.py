#!/usr/bin/env python3
# app.py – Flask SPA + API on one port
...
def match():
    ...
    return jsonify(match_composite_url=url_for('serve_comp', fn=fname))
...
def serve_poster(fn):           # optional direct poster serving
